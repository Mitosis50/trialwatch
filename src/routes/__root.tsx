  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Medical Evidence Commons — a shared library of claims, sources, reviews, and visible corrections. Synthetic prototype.",
      },
      { name: "theme-color", content: "#2c5f56" },
    ],
    links: [
